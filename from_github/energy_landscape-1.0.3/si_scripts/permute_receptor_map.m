...
clear all; close all;
basedir = '/Users/yanw4/Documents/LNI_P1_MP_DFNC_202212/codes/energy_landscape-1.0.3';
cd(basedir);
...
load([basedir,'/results/example/',  'subjcentroids_split',num2str(split),'_k',num2str(numClusters),'.mat'], 'centroids');
load([basedir,'/results/example/', 'subjenergy_split',num2str(split),'_k',num2str(numClusters),'.mat'], 'E_weighted_PLavg');
load([basedir,'/results/example/', 'Partition_bp',num2str(split),'_k',num2str(numClusters),'.mat'], 'clusterNames');

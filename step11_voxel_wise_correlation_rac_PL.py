...
pet_folder = '/Users/yanw4/Documents/LNI_P1_MP_DFNC_202212/data/PET/rac_PL_day/logan_ref/'
...
for dynamic_feature_name in ['fractional_occ_fpn_plus','fractional_occ_som_plus','fractional_occ_vis_minus','dwell_time_fpn_plus','dwell_time_vis_minus','random']:
    ...
    correlation_file_name = './results/example/rac_PL_correlation_'+ dynamic_feature_name +'_stat_map.nii.gz'
    ...
    correlation_file_name = './results/example/rac_PL_correlation_'+ dynamic_feature_name +'_stat_map_20voxel_cluster.nii.gz'
    correlation_img.to_filename(correlation_file_name)
